...
menu_instalar_tomcat() {
    echo -e "${CYAN}Opciones de versiones de Tomcat disponibles en los repositorios de Apache:${RESET}"
    echo "1) LTS (9.0.86)"
    ...
    echo -e "${AMARILLO}Configurando puerto $puerto en server.xml...${RESET}"
    # Cambiar el puerto por defecto 8080 al que elija el usuario y ocultar el nombre del servidor por seguridad
...
EOF
    ...
    echo -e "${VERDE}[✓] Tomcat instalado mediante binarios y configurado con éxito.${RESET}"
}
